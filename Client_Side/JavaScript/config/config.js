...
// Logo size
config.logo.width = '5em';
config.logo.height = '5em';

//Main Logo
config.logo.main.src = 'Icons/Votebox.png';

// Regulator Logo
config.logo.regulator.src = 'Icons/Regulator/Votebox.png';

// Manufacturer Logo
config.logo.manufacturer.src = 'Icons/Manufacturer/Votebox.png';
...
config.participants.users.regulators[0].company = 'PO';
config.participants.users.regulators[0].type = 'Regulator';
config.participants.users.regulators[0].user = 'Eddy';

// Manufacturers
config.participants.users.manufacturers[0] = {};
config.participants.users.manufacturers[0].company = 'Station 1';
config.participants.users.manufacturers[0].type = 'PollingStation';
config.participants.users.manufacturers[0].user = 'Sia';

config.participants.users.manufacturers[1] = {};
config.participants.users.manufacturers[1].company = 'Station 2';
config.participants.users.manufacturers[1].type = 'PollingStation';
config.participants.users.manufacturers[1].user = 'Andy';

config.participants.users.manufacturers[2] = {};
config.participants.users.manufacturers[2].company = 'Station 3';
config.participants.users.manufacturers[2].type = 'PollingStation';
config.participants.users.manufacturers[2].user = 'Joe';

// Dealerships
config.participants.users.dealerships[0] = {};
config.participants.users.dealerships[0].company = 'Counting Station';
config.participants.users.dealerships[0].type = 'Dealership';
config.participants.users.dealerships[0].user = 'John';
