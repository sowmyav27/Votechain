...
function createAsset()
{
    ...
    $('#loaderMessages').html('<u>Creating Voter Template</u><br /><br /><span id="messages"></i>waiting...</i></span><br /></div>&nbsp;');
    ...
    xhr.onreadystatechange = function (){
        if(xhr.readyState === 4)
		{
            ...
            else
			{
                ...
                $('#confTxt').html('Created Voter Template: '+ JSON.parse(array[array.length - 1]).v5cID);
            }
        }
    };
...
function updateAsset(vin, make, model, colour, reg, v5cID, el)
{
	...
	*/
    ...
    bigData = [{'value':vin,'field':'VIN', 'title': 'VID','v5cID':v5cID},{'value':make,'field':'make', 'title': 'Name','v5cID':v5cID},{'value':model,'field':'model', 'title': 'Place','v5cID':v5cID},{'value':colour,'field':'colour', 'title': 'Party','v5cID':v5cID},{'value':reg,'field':'reg', 'title': 'Date','v5cID':v5cID}];
    increment=0;
	...
	{
        spans += '<div class="loaderSpan" id="span'+(i+1)+'"><u>'+bigData[i].title+'</u><br /><br /><span id="msg'+(i+1)+'Part1"></i>waiting...</i></span><br /><span id="msg'+(i+1)+'Part2"></span><br /><span id="msg'+(i+1)+'Part3"></span><br /></div>&nbsp;'; //<span id="msg'+(i+1)+'Part4"></span><br />
    }
