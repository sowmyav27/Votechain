        ...
        */
        ...
        if($('#selVhclsTbl tr').length >= 1 && $('#recipientInfo').html() != '') {
            ...
            for(let i = 0; i < $('#selVhclsTbl tr').length; i++) {
                spans += '<div class="loaderSpan" id="span'+(i+1)+'"><u>Voter Template '+(i+1)+' updated</u><br /><br /></div>&nbsp'; 
            ...
            $('#selVhclsTbl tr').each(function() {
                ...
                $('#confTxt').html('Transaction committed to the blockchain. <br /><br />Polling Officer: '+getCookie('user')+'<br /><br />'+$('.delName').html()+'<br /><br />Templates: '+$('#selVhclsTbl tr').length);
                // $('#confTxt').html('Transaction committed to the blockchain. <br /><br />Polling Officer: '+getCookie('user')+'<br /><br />'+recDets+': '+$('.delName').html()+'<br /><br />Templates: '+$('#selVhclsTbl tr').length);      line 49--- <span id="msg'+(i+1)+'Part1"></i>waiting...</i></span><br /><span id="msg'+(i+1)+'Part2"></span><br /><span id="msg'+(i+1)+'Part3"></span><br /><span id="msg'+(i+1)+'Part4"></span><br /></div>&nbsp;'
            ...
            $('#failTransfer').show();
            $('#failTxt').html('You have not selected any templates to transfer.');
        } else {
            $('#failTransfer').show();
