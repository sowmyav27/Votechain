...
config.users = [
    ...
    {
        enrollmentID: 'Station 1',
        attributes: [
            {name: 'role', value: 'manufacturer'},
            {name: 'username', value: 'Station 1'}
        ],
        registrar: {},
        roles: [],
        affiliation: 'institution_a'
    ...
    {
        enrollmentID: 'Station 2',
        attributes: [
            {name: 'role', value: 'manufacturer'},
            {name: 'username', value: 'Station 2'}
        ],
        registrar: {},
        roles: [],
        affiliation: 'institution_a'
    ...
    {
        enrollmentID: 'Station 3',
        attributes: [
            {name: 'role', value: 'manufacturer'},
            {name: 'username', value: 'Station 3'}
        ],
        registrar: {},
        roles: [],
        affiliation: 'institution_a'
    ...
    {
        enrollmentID: 'Counting Station',
        attributes: [
            {name: 'role', value: 'private'},
            {name: 'username', value: 'Counting Station'}
        ],
        registrar: {},
        roles: [],
        affiliation: 'institution_a'
